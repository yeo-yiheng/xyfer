...
async function approve(addressToApprove, amount, privateKey, sendingAddress) {
    console.log("Approving: " + addressToApprove);
    ...
    const tx = {
      ...
      'data': contract.methods.approve(addressToApprove, amount).encodeABI()
    };
